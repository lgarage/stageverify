...
const SECTION14_COVERAGE_LOCAL = [
  ...
  { steps: "11", topic: "Dispatcher sees Staged — Ready for Pickup", status: "verify", note: "verify-e2e-smoke dispatcher leg" },
...
const SECTION14_COVERAGE_PROD = [
  ...
  { steps: "11", topic: "Dispatcher sees Staged — Ready for Pickup", status: "verify", note: "verify-dispatcher-nav prod" },
  { steps: "12", topic: "BuildOps technician schedule", status: "skip", note: "External system — not scripted" },
