...
| Bootstrap | Atomic `bootstrapFirstAdmin` only (Manager + zero active Admins + `accessControlLocks/firstAdmin` transaction); not a permanent Manager→Admin path (D-69) |
