...
- 2026-08-08: Dan-directed reopen (owner authority): UI/UX default **Sol** primary + readability DoD — Dan requested Sol Medium; platform rejected `gpt-5.6-sol-medium`; locked `gpt-5.6-sol-high` after probe; Grok verifier + SSOT `ui-model-routing.json` (D-63); non-UI Composer unchanged; Sonnet gates unchanged.
