...
| `work-verifier` | Fable-spec phase boundaries, Ship Verifier escalations, "fable verify" | **§ Work Verifier — Fable 5 + Grok conferral (D-24)** — triggers in `model-gates.mdc` § Work Verifier + § Work verify conferral loop |
...
- **Evidence:** `work-verifier:` + `work-verifier-confer:` (AGREE required) + `confer-verified:` when DISAGREE rounds closed; else NOT RUN; spec-phase NOT RUN blocks phase N+1.
