...
| 5 | **§14 E2E residual prod re-verify** — after vendor hub v0.0.44 | Residual §14 band (**1.71%**) | **Agent** (away-130 queued) | No |
...
1. §14 E2E residual prod re-verify (away-130) — **high**, in-repo
