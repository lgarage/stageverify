...
- Last shipped: **v0.0.238** — merge PR #53 dark-mode navy L0–L3 section hierarchy (`#0b1622`/`#122235`/`#182b40`/`#20384f` + cool blue-gray borders); light mode + semantics preserved; gh-pages only (no CF/rules). Merge `4b406c13`. Prod `verify:admin-appearance` PASS. [fast-safe UI]
