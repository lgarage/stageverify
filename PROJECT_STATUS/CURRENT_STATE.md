...
- Last shipped: **v0.0.81** — Staging Map edit spots: drag persists until save/cancel, Cancel reverts session, input contrast #111, save writes code/label/offsets with `mapLayoutSlot`, chip shows saved code.
