...
## Immediate Next Step
- **Lane C C2 PR ready for Dan review** — do **not** merge/deploy CF/rules/gh-pages until Dan approves. Do **not** start C3/C4. Dan/ops: Settings → **Reconnect Gmail**, then smoke one invoice through ingest → Inbox archive + View Original PDF.
