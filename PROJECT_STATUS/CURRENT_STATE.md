...
- Last shipped LIVE: **v0.0.240** — Settings **row-scoped Admin Access** gh-pages only (PR #56 UI); PR #58 dual-read CF already live; PIN length contract exactly 4 digits FE+BE (does not allow >6). [fast-safe UI deploy]
