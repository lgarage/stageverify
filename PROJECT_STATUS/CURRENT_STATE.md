...
- Last shipped: **v0.0.223** — merge PR #39: Settings Workflow **StageVerify Start Date** (`appSettings.stageVerifyActivatedAt`, YYYY-MM-DD); Green Bay live `2026-08-10` (editable); `verify:settings-staging:prod` PASS. [fast-safe UI]
...
## Immediate Next Step
- Dan: hard-refresh Settings → Workflow — confirm StageVerify Start Date shows `2026-08-10` (editable) after v0.0.223.
