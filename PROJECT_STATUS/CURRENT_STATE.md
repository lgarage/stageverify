...
- Last shipped: **away-095** — dispatcher review UI
...
## Immediate Next Step
- **away-097** — verify-invoice-review Playwright script (offline; `npm run away:next`). ESL/shop map do not block unless scope says otherwise.
