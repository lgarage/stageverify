...
- Last shipped: **away-095** — dispatcher invoice review UI (`/invoice-review`)
...
## Immediate Next Step
- **away-096** — harden inspect callables (`npm run away:next`). ESL/shop map do not block unless scope says otherwise.
