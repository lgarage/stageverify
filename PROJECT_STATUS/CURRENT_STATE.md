...
- Last shipped: **v0.0.67** ? Invoice approve: default Approve creates shell (no match auto-link); CF patches orphan shell slots for prod list visibility; First Supply SO-less header validator deployed.
