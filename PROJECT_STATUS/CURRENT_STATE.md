...
- Last shipped: **away-094** — approveVendorInvoiceImport CF + firestore.rules
...
## Immediate Next Step
- **away-095** — dispatcher review UI (offline; `npm run away:next`). ESL/shop map do not block unless scope says otherwise.
