...
- **Partial deploy:** D-59 P2–P7 on `main` (`49924c8b`, v0.0.204). **gh-pages LIVE** @ **v0.0.242** (portal sidebar StageVerify app-icon branding from PR #61). **Firebase rules** for accessPinSecrets already deployed (Phase 1). **CF:** PIN/Admin Access + dual-read verify paths LIVE (no redeploy after PR #58 — live lib hashes matched tip). Sticky-reject / Gmail auto-archive prior deploys unchanged.
