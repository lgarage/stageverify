...
- Last shipped: **away-093** — matchInvoiceToRecords callable
...
## Immediate Next Step
- **away-094** — approveVendorInvoiceImport CF + firestore.rules (offline; `npm run away:next`). ESL/shop map do not block unless scope says otherwise.
