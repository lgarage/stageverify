...
- In flight: **v0.0.238** — dark-mode navy layered surfaces (L0–L3 branded blue-navy hierarchy; borders cool blue-gray); light mode + semantics preserved; rebased onto main tip (PR #54 + PR #55); branch `cursor/dark-mode-navy-layers-ca1d` (PR #53); **hold merge/deploy** pending Dan. [fast-safe UI]
- Last shipped: **PR #55** Gmail auto-archive after durable ingest (D-64) — INBOX remove only after `parsed`/`reply_processed`; soft-fail; View Original PDF still Gmail fetch. Merge `9b908abd`. [high-risk CF]
