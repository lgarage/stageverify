...
- In progress: **D-28 harness gate-check + verifier-log** on `cursor/harness-gate-evidence-6544` (PR pending) — CI `gate-check` workflow + `verifier:log`/`verifier:stats`; PR/CI-only; desktop main push honor-system.
