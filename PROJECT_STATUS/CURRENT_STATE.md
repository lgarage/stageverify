...
- In flight (PR): **drawer fulfillment/staging UX** — Vendor Drop-Off / Will-Call / Pickup wording; staging banner only when required∧unassigned, directly below fulfillment. Branch `cursor/delivery-drawer-fulfillment-staging-3afe`. Hold deploy until Dan review. [fast-safe UI]
