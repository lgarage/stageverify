...
## Immediate Next Step
- Dan/ops: hard-refresh Settings after v0.0.235 for unified PIN & Access Management (Manager/Dispatcher in same roster); set Exception-only Delivered hub when ready; vendor phone still needs Location/Invoice from v0.0.227+.
