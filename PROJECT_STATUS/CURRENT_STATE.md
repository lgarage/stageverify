...
- Last shipped: **v0.0.58** — Prod dispatcher list shows PDF-scanned invoice deliveries only; Readiness Evidence shows scanned invoice source email for all import-linked jobs
