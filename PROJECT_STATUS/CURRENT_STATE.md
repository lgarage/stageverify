...
- Last shipped: **dispatcher staging-action rows** — dark-orange `dispatcher-action-required` table rows + Issue Summary **Assign staging location** when staging zone missing (display-only; ORD-001/002 verify)
