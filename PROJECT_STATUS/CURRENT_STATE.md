...
- Last shipped: **v0.0.194** — Revert dual dark/light theme modernize (ThemeProvider/toggle); restore pre-theme UI chrome.
- Prior: **v0.0.193** — Needs Review **Handle arrival**: clear backorder on vendor reply (shop staging or will-call); `applyVendorReplyClearBackorder` CF + shared `skipsShopStaging` readiness skip.
