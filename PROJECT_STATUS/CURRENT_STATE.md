...
- Last shipped: **v0.0.63** — First Supply SO-less approve fix: shared `asParsedHeaderForImport` (identity = invoice# OR S/O#), modal close on approve. CF (approve+match) + gh-pages deployed 2026-07-19; Sonnet gate PASS; `verify:invoice-review:prod` PASS.
