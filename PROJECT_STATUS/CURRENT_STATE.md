...
- Last shipped: **v0.0.178** — Invoice Review training note panel polish (full-width card above Approve/Reject).
- Prior: **v0.0.177** — Johnstone invoice AI shadow (Vertex lite→3.6, flag-gated) + Invoice Review training notes → GCS playbook; CF deploy required.
