...
- **In flight (PR only, no deploy):** Lane C **C1** Invoice Review Chat — `reviewAgentTurn` CF + `vendorInvoiceImportChats` rules + inspect-modal chat UI (v0.0.245). Live chat needs post-merge CF+rules deploy. Before C3: amend D-59 #7/#8 for field learning.
