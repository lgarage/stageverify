...
## Snapshot
- **MVP: 81.75%** — SSOT: `MVP_PATH.md`. Combo waiver + §14 E2E gate scaffold shipped (`verify:phase14-e2e`).
...
## Immediate Next Step
- **MVP path (priority):** (1) run `verify:phase14-e2e` local+prod PASS, (2) Dan GCP Gmail deploy, (3) e-tag waiver — see `MVP_PATH.md`.
