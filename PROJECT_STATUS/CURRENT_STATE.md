...
- Last shipped LIVE: **v0.0.244** — inactive Manager/Dispatcher **Remove** (`removeDispatcher` CF + Settings UI); smoke-mgr-pr50 + smoke-pr50 Auth accounts permanently removed from production roster; protected ops accounts retained. Merge PR #65 `7b93bb0d`. [high-risk CF + UI]
