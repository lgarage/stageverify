...
- Last shipped: **v0.0.195** — Teach-chat ignore CREDIT/returns (echo→yes) → Firestore `vendorInvoiceIgnoreRules`; Settings Admin edit; ingest auto-skip new matches (D-58 amend).
- Prior: **v0.0.194** — Revert dual dark/light theme modernize (ThemeProvider/toggle); restore pre-theme UI chrome.
