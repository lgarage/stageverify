...
- Last shipped: **away-033** — shop stock Not Pulled / Pulled / Staged labels; away-032 checklist persist prior.
...
## Immediate Next Step
0. **Away queue:** Run `away-034`…`041` — away-033 shipped; away-028 deferred (geofence); protocol: `PROJECT_STATUS/AWAY_BUILD_PROTOCOL.md`.
