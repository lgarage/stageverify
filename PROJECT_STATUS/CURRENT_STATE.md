...
- Last shipped: **v0.0.131** — Shop map `persistEdit`: single extras object + one `onPersistLayoutExtras` flush (catch-all + YAH/door/hidden); `verify:catch-all-map` Done+YAH regression.
