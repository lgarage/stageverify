...
- Last shipped: **v0.0.85** — Staging Map edit: nudge arrows, typeable W/H ±, rotation (mapRotationDeg), add ground/shelf/shelf-spot (appSettings extras), Composer-codes/Grok-verifies rule.
