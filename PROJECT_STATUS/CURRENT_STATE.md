...
- Last shipped: **away-031** — PO line labels on pickup item rows; away-030 location sections prior; away-028 geofence deferred.
...
## Immediate Next Step
0. **Away queue:** Run `away-032`…`041` — away-031 shipped; away-028 deferred (geofence); protocol: `PROJECT_STATUS/AWAY_BUILD_PROTOCOL.md`.
