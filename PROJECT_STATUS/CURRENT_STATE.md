...
- Last shipped: **v0.0.130** — Delivery drawer: removed legacy action buttons (invoice review, pickup schedule toggle, vendor QR, copy pickup), Planned Staging instruction block, and Items list (Firestore item data unchanged).
