...
- Last shipped: **away-084** — Drawer Items/Pickup Summary/Activity History UI cleanup (ORD-005)
...
## Immediate Next Step
- **away-083** — Mini-librarian phase 3: away:ship + validate sync project_state Immediate Next (`npm run away:next`). ESL/shop map do not block unless scope says otherwise.
