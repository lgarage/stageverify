...
- Last shipped: **away-034** — Running Low on shop stock lines (running_low material issue); away-033 Staged label prior.
...
## Immediate Next Step
0. **Away queue:** Run `away-035`…`041` — away-034 shipped; away-028 deferred (geofence); protocol: `PROJECT_STATUS/AWAY_BUILD_PROTOCOL.md`.
