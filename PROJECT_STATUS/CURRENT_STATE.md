...
- Last shipped: **v0.0.157** — hide verify seed Catch-All rows in Settings; one signup form (Name → Email → SMS → Activate); strengthened `verify:settings-office-receivers`.
