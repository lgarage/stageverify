...
- Last shipped: **away-032** — persist pickup item checklist (`pickupCheckedItemIds` + `updatePickupChecklist` CF); away-031 PO labels prior.
...
## Immediate Next Step
0. **Away queue:** Run `away-033`…`041` — away-032 shipped; away-028 deferred (geofence); protocol: `PROJECT_STATUS/AWAY_BUILD_PROTOCOL.md`.
