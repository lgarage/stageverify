...
- Prior: **v0.0.185** — CREDIT/return parse: reject canonical label-token headers (Customer#≠Order), keep Johnstone return lines, advisory copy; CF deploy needed for live Refresh
