...
| 2026-08-23 | Delivery Details unified Order Summary (delivered stays in same list) | ui-component / visual-judgment | T1 | Sol High (`gpt-5.6-sol-high`) + Grok orchestrate/ship | 98 | 99 | FE-only v0.0.307; deriveItemIssueDisplayStatus + effectiveItemQtyReceived; no CF/rules |
