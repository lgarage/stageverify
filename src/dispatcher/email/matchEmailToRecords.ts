import type { DeliveryOrder, Job, PurchaseOrder, Vendor } from "../models";
import type { EmailMatchCandidate, InboundEmailMessage, ParsedEmailContent } from "./types";
import {
  EMAIL_AUTO_APPLY_CONFIDENCE,
  EMAIL_REVIEW_CONFIDENCE,
} from "./types";
...
): { vendor?: Vendor; score: number; reason: string } {
