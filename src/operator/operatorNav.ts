/** Operator console sidebar navigation (separate from dispatcher PORTAL_NAV_ITEMS). */
...
export function isOperatorNavItemActive(
  ...
  switch (item.label) {
    ...
    case "Customers":
      return (
        pathname.startsWith("/operator/customers") &&
        pathname !== "/operator/customers/new"
      );
    case "Onboarding":
      return pathname === "/operator/customers/new";
    default:
      return false;
  }
}
