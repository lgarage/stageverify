...
**ID:** `away-125`  
**Title:** Mechanical ESLint cleanup (safe subset)
...
5. Implement → verify → append timing to `PROJECT_STATUS/estimate-log.md` → `npm run away:ship -- --id away-125 --note "<summary>"`
