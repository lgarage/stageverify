...
**ID:** `away-124`  
**Title:** Harness health: fix verify:pickup post-reseed flake + auth for Scenario A
...
5. Implement → verify → append timing to `PROJECT_STATUS/estimate-log.md` → `npm run away:ship -- --id away-124 --note "<summary>"`
