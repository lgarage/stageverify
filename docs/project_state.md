...
**D-73 unplanned dispatcher drawer (shipped 2026-08-09, v0.0.263):** `getDeliveryDetails` loads job-less unplanned shells without throwing; drawer shows Needs job match / — for missing PO/job and keeps staging + unplanned review note. Verify: `node scripts/verify-unplanned-delivery-drawer.mjs`; D-73 `verify:vendor-unplanned-delivery` opens the job-less prior row in the dispatcher drawer.
