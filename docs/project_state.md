...
**Marketing landing page (shipped 2026-06-21):** Public homepage at `/#/` for unauthenticated visitors — hero, problem/solution/features, industry cards, demo CTA. Logged-in users still redirect to `/hub`. Vendor receive deep links unchanged (`/#/receive`). Verify: `npm run verify:landing`.
