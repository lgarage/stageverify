...
1. **MVP fastest path (D-24):** see `PROJECT_STATUS/MVP_PATH.md` — **81.75%** complete (SSOT); priority: (a) run `verify:phase14-e2e` local+prod PASS, (b) Dan GCP Gmail deploy, (c) e-tag waiver.
