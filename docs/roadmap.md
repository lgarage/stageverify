...
- **Review Vendor Email modal (v0.0.318):** ✅ Shipping — Delivery Details **Review Vendor Email** opens a centered read-only overlay; View Full Email Chain remains in-drawer; Email Vendor compose unchanged
