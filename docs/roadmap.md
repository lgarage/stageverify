...
**Shipped (2026-08-25):** Vendor company-run list keeps one landing tree + display-only list cache after PIN — **v0.0.330** gh-pages FE-only; warm re-login paints cached cards before list CF. Real iPhone still unproven.
...
- **Review Vendor Email modal (v0.0.318):** ✅ LIVE — Delivery Details **Review Vendor Email** opens a centered read-only overlay; View Full Email Chain remains in-drawer; Email Vendor compose unchanged
