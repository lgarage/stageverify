...
**Shipping (2026-08-09):** Will-Call / Pickup pink Dispatcher category + staging release on fulfillment toggle (v0.0.278) — derived category (not new status enum); reverse Drop-Off never restores prior spot; FE-only.
