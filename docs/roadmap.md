...
**Shipped (2026-08-23):** Delivery Details Order Summary is one list (unfinished first, delivered last, green delivered) — **v0.0.307** gh-pages FE-only; Items Received accordion removed; View original PDF under Close unchanged; no CF/rules.
