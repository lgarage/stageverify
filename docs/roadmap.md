...
**Shipped (2026-08-09):** Vendor Drop-Off delivered-card auto-collapse (compact green DELIVERED row in place; independent expand; vendor-run stable order; Undo on expanded hub) — **v0.0.257** gh-pages FE-only.
