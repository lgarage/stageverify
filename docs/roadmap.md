...
**Shipped (2026-08-18):** Vendor location-scan Safari history (**v0.0.292**) — PIN → deliveries → order are real `#/s?loc=` history views; hash canonicalize uses replaceState; delivery-id PIN no longer strips to bare `#/receive`. FE-only.
