...
- **Settings StageVerify Start Date (v0.0.222):** `appSettings.stageVerifyActivatedAt` (`YYYY-MM-DD`) — Workflow calendar field for “Since StageVerify started” reporting baseline; no auto-now / delivery inference / history rewrite; Green Bay configured `2026-08-10` (editable)
