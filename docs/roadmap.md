...
- **Dark mode navy section hierarchy (2026-08-08):** ⏳ PR #53 ready v0.0.238 — branded L0–L3 blue-navy surfaces + cool blue-gray borders (replacing near-black flat canvas); rebased onto main tip (PR #54 staging/select/wording + PR #55 Gmail auto-archive); light mode unchanged; hold merge/deploy pending Dan
