import{A as e,Da as t,Pi as n,Ta as r,yr as i}from"./index-Dm7fUc_P.js";import{t as a}from"./EslQrCode-DBtNOArX.js";var o=t(r(),1),s=i();function c(e){let t=e?.trim()??``;return t?n(t):``}var l=`location-sign-print-page`,u=`In the print dialog, turn off Headers and footers for a clean sign-only page.`,d=`stageverify`;function f(e){(0,o.useEffect)(()=>{let t=e.trim()||` `;document.title=t;let n=()=>{document.title=t},r=()=>{document.title=d};return window.addEventListener(`beforeprint`,n),window.addEventListener(`afterprint`,r),()=>{window.removeEventListener(`beforeprint`,n),window.removeEventListener(`afterprint`,r),document.title=d}},[e])}var p=`
