import{fi as e,qr as t,r as n,tr as r,ui as i}from"./index-VhWVO-Ic.js";import{t as a}from"./EslQrCode-BDXEImtu.js";var o=e(i(),1),s=t();function c(e){let t=e?.trim()??``;return t?r(t):``}var l=`location-sign-print-page`,u=`In the print dialog, turn off Headers and footers for a clean sign-only page.`,d=`stageverify`;function f(e){(0,o.useEffect)(()=>{let t=e.trim()||` `;document.title=t;let n=()=>{document.title=t},r=()=>{document.title=d};return window.addEventListener(`beforeprint`,n),window.addEventListener(`afterprint`,r),()=>{window.removeEventListener(`beforeprint`,n),window.removeEventListener(`afterprint`,r),document.title=d}},[e])}var p=`
