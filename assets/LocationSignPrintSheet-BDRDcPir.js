import{_i as e,cr as t,ei as n,r,yi as i}from"./index-CsRWGNOR.js";import{t as a}from"./EslQrCode-X1lnR44l.js";var o=i(e(),1),s=n();function c(e){let n=e?.trim()??``;return n?t(n):``}var l=`location-sign-print-page`,u=`In the print dialog, turn off Headers and footers for a clean sign-only page.`,d=`stageverify`;function f(e){(0,o.useEffect)(()=>{let t=e.trim()||` `;document.title=t;let n=()=>{document.title=t},r=()=>{document.title=d};return window.addEventListener(`beforeprint`,n),window.addEventListener(`afterprint`,r),()=>{window.removeEventListener(`beforeprint`,n),window.removeEventListener(`afterprint`,r),document.title=d}},[e])}var p=`
